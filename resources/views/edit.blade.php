			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Edit Ruas</h4>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="{{ route('edit.ruas', $data['id'])}}" method="POST">
										@csrf
										<div class="row">
											<div class="col-md-6 col-lg-4">
												...
												<div class="form-group form-group-default">
													<label>Ruas</label>
													<input type="text" value="{{ $data['ruas'] }}" name="ruas" class="form-control" placeholder="Masukkan Nama Ruas">
												</div>
												<!-- <div class="form-group form-group-default">
												...
												<div class="form-group form-group-default">
													<label>Tanggal</label>
													<input name="date_create" value="{{ $data['date_create'] }}" type="date" class="form-control" placeholder="fill office">
												</div>
											</div>
										</div>
